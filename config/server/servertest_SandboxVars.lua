SandboxVars = {
    ...
    LootItemRemovalList = "Base.BookCarpentry1;Base.BookCarving1;Base.BookCooking1;Base.BookElectrician1;Base.BookFarming1;Base.BookFirstAid1;Base.BookFishing1;Base.BookFlintKnapping1;Base.BookForaging1;Base.BookGlassmaking1;Base.BookMasonry1;Base.BookMechanic1;Base.BookMetalWelding1;Base.BookBlacksmith1;Base.BookPottery1;Base.BookTailoring1;Base.BookTrapping1;Base.BookAiming1;Base.BookReloading1;Base.BookHusbandry1;Base.BookButchering1;Base.BookTracking1;Base.BookLongBlade1;Base.BookMaintenance1",
    ...
    SafeZone = {
        ...
        WelcomeText = "<CENTRE> <SIZE:small> Welcome! <LINE><LINE> Check our Discord for guides and rules. <LINE><LINE> Have fun and stay safe!",
        WelcomeDiscordURL = "",
        WelcomeServerURL = "",
    },
    DAMN = {
    ...
    ToxicSky = {
        UseSandboxOverrides = false,
        RandomEventsEnabled = true,
        EnableLightGasEvents = true,
        EnableHeavyGasEvents = true,
        EnableFalloutEvents = true,
        BypassUtilitiesRequirement = false,
        DiminishingSpawnsOverTime = true,
        -- Min: 1 Max: 720 Default: 6
        SmallLeakIntervalHours = 6,
        -- Min: 1 Max: 720 Default: 12
        HeavyGasIntervalHours = 12,
        -- Min: 1 Max: 1440 Default: 72
        FalloutIntervalHours = 72,
        -- Min: 30 Max: 1000 Default: 150
        GasDiminishIntervalDays = 150,
        -- Min: 30 Max: 1000 Default: 250
        GasDiminishChanceDays = 250,
        -- Min: 1 Max: 720 Default: 4
        LightGasDurationMinHours = 4,
        -- Min: 1 Max: 720 Default: 8
        LightGasDurationMaxHours = 8,
        -- Min: 1 Max: 720 Default: 8
        HeavyGasDurationMinHours = 8,
        -- Min: 1 Max: 720 Default: 14
        HeavyGasDurationMaxHours = 14,
        -- Min: 1 Max: 1440 Default: 24
        FalloutDurationMinHours = 24,
        -- Min: 1 Max: 1440 Default: 48
        FalloutDurationMaxHours = 48,
        -- Min: 0.00 Max: 20.00 Default: 4.00
        FalloutDriftSpeed = 4.0,
        -- Min: 0.00 Max: 1.00 Default: 0.65
        FalloutIndoorProtection = 0.65,
        FalloutCropDamageEnabled = false,
        -- Min: 0.00 Max: 3.00 Default: 0.20
        GasMaskDamagePerHit = 0.2,
        -- Min: 0 Max: 100 Default: 25
        FilterSaturationThresholdPercent = 25,
        -- Min: 0.00 Max: 50.00 Default: 3.00
        PlayerToxicityValue = 3.0,
        -- Min: 0.00 Max: 5.00 Default: 0.10
        AnimalDamageMultiplier = 0.1,
        -- Min: 0.00 Max: 1.00 Default: 0.50
        VehicleExposureMultiplier = 0.5,
        -- Min: 0.00 Max: 1.00 Default: 0.30
        SmokeOutdoorToxicityMultiplier = 0.3,
        -- Min: 1 Max: 720 Default: 60
        SmokeLingerMinutes = 60,
        -- Min: 1 Max: 30 Default: 1
        SmokeActiveScanMinutes = 1,
        -- Min: 1 Max: 120 Default: 10
        SmokeDormantScanMinutes = 10,
        -- Min: 4 Max: 40 Default: 16
        SmokeScanRadiusTiles = 16,
        -- Min: 1 Max: 30 Default: 8
        SmokeMaxSources = 8,
        -- Min: 100 Max: 5000 Default: 1200
        SmokeMaxSquaresPerScan = 1200,
    },
    PhunLewt = {
        Debug = false,
    },
    ...
    Architect = {
        Restricted = true,
        Cost = false,
        ItemCostPerSquare = "Base.Plank:0.25;Base.Nails:1.0001",
