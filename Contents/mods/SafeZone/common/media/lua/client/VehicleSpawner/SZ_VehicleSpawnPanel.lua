...
local SZ_VehicleSpawnPanel = ISPanel:derive("SZ_VehicleSpawnPanel")
...
function SZ_VehicleSpawnPanel.close()
    local SZ_VehicleSpawnerWindow = require("SZ_VehicleSpawnerWindow")
    SZ_VehicleSpawnPanel.hide()
    SZ_VehicleSpawnerWindow.show()
end

return SZ_VehicleSpawnPanel
